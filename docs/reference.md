...
flat Python import roots, parse diagnostics, and automatic monorepo shared-dependency discovery (no extra root setting; opt out with `discover_shared_dependencies: false`).
